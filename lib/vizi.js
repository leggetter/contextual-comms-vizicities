// var coords = [40.739940, -73.988801]; // Manhattan
var coords = [51.4015, -2.597]; // near bristolJS

var vizi = VIZI.world('world', {
  // skybox: true,
  // postProcessing: true
}).setView(coords);

// Set position of sun in sky
// vizi._environment._skybox.setInclination(0.3);

// Add controls
var orbit = VIZI.Controls.orbit().addTo(vizi);
